...
export default function RamPotteryDoc(props: RamPotteryDocProps) {
  const {
    ...
    logoSrc = "/logo.png", // ✅ your public path
  ...
  const phonesLine =
    company?.phonesLine || "Tel: +230 57788884  +230 58060268  +230 52522844";
            ...
            <div className="box-content rpdoc-boxContentTight">
              ...
              <div className="rpdoc-kv">
                ...
                <div className="v">
                  {txt(salesRepName)}
                  {salesRepPhone ? (
                    <span className="rpdoc-inlineTel">Tel: {txt(salesRepPhone)}</span>
                  ) : null}
                </div>
              </div>
            </div>
        ...
        <div className="notes-totals">
          <div className="notes">
            ...
            <ul>
              ...
              <li>For any manufacturing defects, must provide this invoice for a refund or exchange.</li>
